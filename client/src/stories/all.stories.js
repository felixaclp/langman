...
import { SignInScreen, WinScreen, LoseScreen, PlayScreen } from '../screen.js';
...
storiesOf('Screens', module)
    ...
    .add('WinScreen', () => (
        <div>
            <h2>Win Screen(lang, playAgain, clickQuit)</h2>
            <ul>
    ...
    .add('LoseScreen', () => (
        <div>
            ...
            <ul>
                ...
                <li>lang - the language in which the last game was played</li>
                <li>clickPlayAgain - callback taking the new language choice</li>
                <li>clickQuit - callbac to quit playin</li>
            </ul>
...
storiesOf('Banners and Displays', module)
    .add('Banner', () => (
        <div>
            <h2>Banner(full)</h2>
                <p>This component includes both Banner and ShortTitle from the design docs.</p>
            <ul>
                <li>full - truthy means wide tittle is shown with subtitle,
    ...
    .add('UsageAndBlanks', () => (
        <div>
            ...
            <p>This component uses the non-Reac function prepareUsage.</p>
            <ul>
                <li>usage - usage example with guess word as underscores</li>
                <li>balnks - guessed/non-guessed letters, like "h_ml_t"</li>
                <li>showBlanks - wheter to show blanks separately or in usage</li>
            </ul>
            <h3>With blanks</h3>
            <UsageAndBlanks
                usage="The sky loomed dark and _______."
                blanks="__oo_y"
                showBlanks={true}
            />
...
storiesOf('Button-related Components', module)
    ...
    .add('StartForm', () => (
        <div>
            ...
            <ul>
                <li>Click Start - game starting callback, takes name and language</li>
            </ul>
